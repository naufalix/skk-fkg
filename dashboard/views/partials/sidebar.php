          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($page==='probinmaba') {echo 'bg-light';} ?>" href="probinmaba">
                ...
                <span class="nav-link-text">SKK Probinmaba</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($page==='kegiatan') {echo 'bg-light';} ?>" href="kegiatan">
                <i class="fa fa-trophy text-default"></i>
                <span class="nav-link-text">SKK Kegiatan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($page==='lain-lain') {echo 'bg-light';} ?>" href="lain-lain">
                <i class="fa fa-plane text-default"></i>
                <span class="nav-link-text">SKK Lain-lain</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($page==='kelulusan') {echo 'bg-light';} ?>" href="kelulusan">
                <i class="fa fa-graduation-cap text-default"></i>
                <span class="nav-link-text">Detail Kelulusan</span>
              </a>
            </li>
